function french() {
    ...
    document.getElementById("loginHeader").textContent = "Connecter";
    document.getElementById("password").textContent = "Mot de Passe";
    document.getElementById("validate-btn-login").textContent = "Enregistre les choix";
    document.getElementById("login").textContent = "nom d'utilisateur";
...
function english() {
    ...
    document.getElementById("validate-btn-login").textContent = "Save Changes";
...
function japanese() {
    ...
    document.getElementById("loginHeader").textContent = "ログイン";
    document.getElementById("password").textContent = "パスワード";
    document.getElementById("validate-btn-login").textContent = "変更を保存";
